...
public class YahooFinanceScraper implements Scraper{
    ...
    private static final String SUMMARY_URL = "http://finance.yahoo.com/quote/%s/profile/";
    ...
    public ScrapedResult scrap(Company company) {
        ...
        try {
            ...
            String tableSelector = "#nimbus-app > section > section > section > article > div.container > div.table-container.yf-ewueuo > table";

            Elements parsingDivs = document.select(tableSelector);
